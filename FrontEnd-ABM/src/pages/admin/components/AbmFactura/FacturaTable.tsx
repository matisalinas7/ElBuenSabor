            ...
            <tbody>
                {facturas.map(factura => (
                    <tr key={factura.id} className={factura.fechaBaja ? 'table-danger' : ''}>
                        ...
                        <td>
      <Button variant="light" onClick={() => handleClick("Editar factura", factura, ModalType.UPDATE)}>
        <PencilFill color='orange' />
      </Button>
      {factura.fechaBaja !== null && (
        <Button variant="light" onClick={() => handleClick("Dar de alta factura", factura, ModalType.RESTORE)}>
          <ArrowUp color='green' />
        </Button>
      )}
      {factura.fechaBaja === null && (
        <Button variant="light" onClick={() => handleClick("Dar de baja factura", factura, ModalType.DELETE)}>
          <ArrowDown color='red' />
        </Button>
      )}
    </td>
