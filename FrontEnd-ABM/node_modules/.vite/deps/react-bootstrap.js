import {
  ...
  TabContext_default,
  useNavItem
} from "./chunk-SVK4ZEXN.js";
import {
  Spinner_default
} from "./chunk-SIHJ43A5.js";
import {
  ...
  useWaitForDOMRef,
  useWillUnmount
} from "./chunk-AWVT5V5C.js";
import {
  AlertHeading_default,
  AlertLink_default,
  Alert_default
} from "./chunk-Q2LR3ETE.js";
import {
  CloseButton_default,
  ENTERING,
  EXITING,
...
} from "./chunk-AXN4KXAN.js";
import "./chunk-NHDTVBDN.js";
import {
  contains
} from "./chunk-D2WHNP5H.js";
import {
...
var FigureImage = React31.forwardRef(({
  className,
  fluid = true,
  ...props
...
var FigureCaption = React32.forwardRef(({
  className,
  bsPrefix,
...
var FormFloating = React40.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Switch = React46.forwardRef((props, ref) => (0, import_jsx_runtime46.jsx)(FormCheck_default, {
  ...props,
  ref,
  type: "switch"
}));
...
var ModalTitle = React57.forwardRef(({
  className,
  bsPrefix,
...
var Modal = React58.forwardRef(({
  ...
  const renderBackdrop = (0, import_react19.useCallback)((backdropProps) => (0, import_jsx_runtime59.jsx)("div", {
    ...backdropProps,
...
var NavDropdown = React59.forwardRef(({
  id,
  title,
  children,
  bsPrefix,
...
// node_modules/@restart/ui/esm/Overlay.js
var Overlay = React60.forwardRef((props, outerRef) => {
  const {
    flip,
    offset,
    placement,
...
var PopoverHeader = React61.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var PopoverBody = React62.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var Popover = React64.forwardRef(({
  bsPrefix,
  placement = "right",
  className,
  style,
...
var Tooltip = React65.forwardRef(({
  ...
  return (0, import_jsx_runtime67.jsxs)("div", {
    ...
    children: [(0, import_jsx_runtime66.jsx)("div", {
      ...
      ...arrowProps
    }), (0, import_jsx_runtime66.jsx)("div", {
...
var Overlay2 = React66.forwardRef(({
  children: overlay,
  ...
  return (0, import_jsx_runtime68.jsx)(Overlay_default, {
    ...outerProps,
    ref: mergedRef,
    popperConfig: {
      ...popperConfig,
    ...
    children: (overlayProps, {
      ...
      return React66.cloneElement(overlay, {
        ...overlayProps,
        placement: updatedPlacement,
        arrowProps,
        popper,
...
var OverlayTrigger = ({
  ...
  const {
    ...
    onBlur,
    onClick
  } = typeof children !== "function" ? React67.Children.only(children).props : {};
  const attachRef = (r) => {
  ...
  return (0, import_jsx_runtime71.jsxs)(import_jsx_runtime70.Fragment, {
    children: [typeof children === "function" ? children(triggerProps) : (0, import_react24.cloneElement)(children, triggerProps), (0, import_jsx_runtime69.jsx)(Overlay_default2, {
      ...props,
      show,
      onHide: handleHide,
      flip,
...
var PageItem = React68.forwardRef(({
  active = false,
  disabled = false,
  className,
  style,
  ...
  return (0, import_jsx_runtime72.jsx)("li", {
    ref,
    style,
    ...
    children: (0, import_jsx_runtime73.jsxs)(Component2, {
      className: (0, import_classnames59.default)("page-link", linkClassName),
      style: linkStyle,
      ...props,
      children: [children, active && activeLabel && (0, import_jsx_runtime72.jsx)("span", {
        className: "visually-hidden",
...
function createButton(name, defaultValue, label = name) {
  const Button = React68.forwardRef(({
    children,
    ...props
  }, ref) => (0, import_jsx_runtime73.jsxs)(PageItem, {
    ...props,
    ref,
...
var Pagination = React69.forwardRef(({
  bsPrefix,
  className,
  size: size2,
  ...props
  ...
  return (0, import_jsx_runtime74.jsx)("ul", {
    ref,
    ...props,
...
var PlaceholderButton = React70.forwardRef((props, ref) => {
  const placeholderProps = usePlaceholder(props);
  return (0, import_jsx_runtime75.jsx)(Button_default, {
    ...placeholderProps,
    ref,
    disabled: true,
    tabIndex: -1
...
var Placeholder = React71.forwardRef(({
  as: Component2 = "span",
  ...props
}, ref) => {
  const placeholderProps = usePlaceholder(props);
...
function renderProgressBar({
  ...
  return (0, import_jsx_runtime77.jsx)("div", {
    ...
    "aria-valuemin": min,
    "aria-valuemax": max,
    children: visuallyHidden ? (0, import_jsx_runtime77.jsx)("span", {
      className: "visually-hidden",
      children: label
    }) : label
  });
}
var ProgressBar = React72.forwardRef(({
  isChild = false,
  ...rest
}, ref) => {
  const props = {
...
var Ratio = React73.forwardRef(({
  ...
  return (0, import_jsx_runtime78.jsx)("div", {
    ...
    children: React73.Children.only(children)
  });
});
...
var SplitButton = React75.forwardRef(({
  id,
  bsPrefix,
  size: size2,
  variant,
  ...
  flip,
  ...props
}, ref) => (0, import_jsx_runtime81.jsxs)(Dropdown_default, {
  ref,
  ...props,
  as: ButtonGroup_default,
  children: [(0, import_jsx_runtime80.jsx)(Button_default, {
    size: size2,
    variant,
    ...
    type,
    children: title
  }), (0, import_jsx_runtime80.jsx)(Dropdown_default.Toggle, {
    split: true,
    id,
    size: size2,
    variant,
  ...
  }), (0, import_jsx_runtime80.jsx)(Dropdown_default.Menu, {
    role: menuRole,
    renderOnMount: renderMenuOnMount,
    rootCloseEvent,
    flip,
...
var TabPanel = React77.forwardRef(
  // Need to define the default "as" during prop destructuring to be compatible with styled-components github.com/react-bootstrap/react-bootstrap/issues/3595
  (_ref2, ref) => {
    let {
      as: Component2 = "div"
    ...
    return (0, import_jsx_runtime83.jsx)(TabContext_default.Provider, {
      ...
      children: (0, import_jsx_runtime83.jsx)(SelectableContext_default.Provider, {
        ...
        children: (0, import_jsx_runtime83.jsx)(Transition, {
          ...
          mountOnEnter,
          unmountOnExit,
          children: (0, import_jsx_runtime83.jsx)(Component2, Object.assign({}, tabPanelProps, {
            ref,
            hidden: !isActive,
...
var TabContainer = ({
  transition,
  ...props
}) => (0, import_jsx_runtime85.jsx)(Tabs_default, {
  ...props,
...
var TabContent = React80.forwardRef(({
  className,
  bsPrefix,
  as: Component2 = "div",
  ...props
...
var TabPane = React81.forwardRef(({
  bsPrefix,
  transition,
  ...props
}, ref) => {
...
var Table = React82.forwardRef(({
  ...
  const table = (0, import_jsx_runtime88.jsx)("table", {
    ...props,
    className: classes,
    ref
  });
...
var ToggleButton = React90.forwardRef(({
  ...
  return (0, import_jsx_runtime99.jsxs)(import_jsx_runtime98.Fragment, {
    children: [(0, import_jsx_runtime97.jsx)("input", {
      ...
      id
    }), (0, import_jsx_runtime97.jsx)(Button_default, {
      ...props,
      ref,
